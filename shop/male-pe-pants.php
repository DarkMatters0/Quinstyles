...
<body id="home">
    ...
    <div class="shop-container">
        <!-- Product Card -->
        <div class="card">
            <img src="../img/pantspe.png" alt="Student Uniform" style="height: 50vh">
            <div class="card-body">
                <h3 class="card-title">PE Pants</h3>
            </div>
        </div>
            ...
            <div class="size-options" id="size-options">
                ...
                <div class="size-group">
                    ...
                    <div class="size-options-row">
                        <div class="size-option" data-value="29">#24</div>
                        <div class="size-option" data-value="30">#25</div>
                        <div class="size-option" data-value="31">#26</div>
                        <div class="size-option" data-value="32">#27</div>
                    </div>
                </div>
                ...
                <div class="size-group">
                    ...
                    <div class="size-options-row">
                        <div class="size-option" data-value="36">#28</div>
                        <div class="size-option" data-value="37">#29</div>
                        <div class="size-option" data-value="38">#30</div>
                        <div class="size-option" data-value="39">#31</div>
                        <div class="size-option" data-value="40">#32</div>
                        <div class="size-option" data-value="40">#33</div>
                    </div>
                </div>
                ...
                <div class="size-group">
                    ...
                    <div class="size-options-row">
                        <div class="size-option" data-value="41">#34</div>
                        <div class="size-option" data-value="42">#35</div>
                        <div class="size-option" data-value="43">#36</div>
                        <div class="size-option" data-value="44">#37</div>
                        <div class="size-option" data-value="45">#38</div>
                        <div class="size-option" data-value="45">#39</div>
                        <div class="size-option" data-value="45">#40</div>
                        <div class="size-option" data-value="45">#41</div>
                        <div class="size-option" data-value="45">#42</div>
                        <div class="size-option" data-value="45">#43</div>
                        <div class="size-option" data-value="45">#44</div>
                    </div>
                </div>
            </div>
